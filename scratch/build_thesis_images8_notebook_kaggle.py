...
notebook_path = r"c:\Users\YUT9HC\Desktop\Z\thesis-all\notebooks\thesis_mipnerf360_images8_specfastgs_kaggle.ipynb"
...
# Cell 5: Git Clone Code
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "id": "cell_05_code_clone",
    "metadata": {},
    "outputs": [],
    "source": [
...
# Cell 7: Discovery & Symlink Dataset Code
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "id": "cell_07_code_symlink",
    "metadata": {},
    "outputs": [],
    "source": [
...
# Cell 9: Verify Dataset Code
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "id": "cell_09_code_verify_layout",
    "metadata": {},
    "outputs": [],
    "source": [
...
# Cell 11: Setup Dependencies Code
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "id": "cell_11_code_compile",
    "metadata": {},
    "outputs": [],
    "source": [
...
# Cell 12: Compile Submodules Code
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "id": "cell_12_code_build_extensions",
    "metadata": {},
    "outputs": [],
    "source": [
        "%%bash\n",
...
# Cell 15: Monitor Experiments Code
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "id": "cell_15_code_monitor",
    "metadata": {},
    "outputs": [],
    "source": [
...
# Cell 16: Markdown Step 6
cells.append({
    "cell_type": "markdown",
    "id": "cell_16_md_aggregate",
    "metadata": {},
    "source": [
...
# Cell 17: Results Aggregation Code
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "id": "cell_17_code_aggregate",
    "metadata": {},
    "outputs": [],
    "source": [
...
print(f"Kaggle Notebook successfully written to: {notebook_path}")
