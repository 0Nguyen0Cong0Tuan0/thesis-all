...
cells.append({
    ...
    "source": [
        ...
        "    # Tìm file prior tương ứng theo đúng định dạng xuất ra từ extract_reflection_prior.py ({cam_name}_ref_score.png)\n",
...
cells.append({
    ...
    "source": [
        ...
        "    \n",
        "    # 1. Kích hoạt Git LFS cho file binary .ply trên Hugging Face Repo\n",
        ...
        "            repo_type=\"dataset\"\n",
        "        )\n",
        "        print(\"✅ Đã thiết lập Git LFS (.gitattributes) cho file binary .ply trên Hugging Face Repo!\")\n",
        "    except Exception as git_err:\n",
        "        print(f\"⚠️ Cấu hình .gitattributes: {git_err}\")\n",
        "    \n",
        "    # 2. Upload toàn bộ thư mục kết quả\n",
