...
cells.append({
    ...
    "outputs": [],
    "source": [
        "# ── Clone Repo & Thiết Lập Symlink Dataset 'counter' ───────────────────────────\n",
        "import os\n",
        "import shutil\n",
        "\n",
        ...
        "\n",
        "# Tạo cấu hình symlink cho scene counter\n",
        ...
        "        if os.path.isdir(src_item) and item in [\"images_8\", \"images_4\", \"images\", \"sparse\"]:\n",
        ...
        "    print(\"✅ Tạo liên kết Symlink cho scene 'counter' thành công!\")\n",
        "else:\n",
...
cells.append({
    ...
    "outputs": [],
    "source": [
        "# ── KHÂU 0 & KHÂU 1: Chọn 10 Góc Chụp Cố Định & Render Mây Điểm Ban Đầu (Iter 0) ───\n",
        "import os\n",
        "import sys\n",
        "import json\n",
        "import torch\n",
        ...
        "\n",
        "sys.path.append(os.path.join(PROJECT_DIR, \"spec-fastgs\"))\n",
        ...
        "\n",
        "# Khởi tạo cấu hình GaussianModel & Scene\n",
        "parser = ModelParams()\n",
        "args = parser.extract([\"-s\", source_path, \"-i\", \"images_8\", \"--eval\"])\n",
        ...
        "pipe_parser = PipelineParams()\n",
        "pipe = pipe_parser.extract([])\n",
        "\n",
...
# Cell 8: Step 4: Upload Everything to Hugging Face Dataset (Code)
cells.append({
    "cell_type": "code",
    "execution_count": None,
    "id": "cell_08_upload_huggingface",
    "metadata": {},
    "outputs": [],
    "source": [
...
print(f"Kaggle Demo Video Notebook successfully written to: {notebook_path}")
