...
# Extract scene name from the dataset path (e.g. counter from ./datasets/mipnerf360/counter)
SCENE_NAME=$(basename "$(realpath -m "$DATASET_PATH")")

echo "========================================================================"
echo " Starting FastGS BASE Training Pipeline"
echo "========================================================================"
