...
DATA_ROOT=${DATA_ROOT:-./datasets/Ref-NeRF/refnerf}
...
echo "Output Path  : ${OUTPUT_ROOT}/${SCENE}${OUTPUT_SUFFIX}"
echo "========================================================================"
...
echo " Results and train_info.json are saved in ${OUTPUT_ROOT}/${SCENE}${OUTPUT_SUFFIX}"
echo "========================================================================"
